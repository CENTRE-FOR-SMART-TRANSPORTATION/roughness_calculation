...
def fintM(t1, t2, y1, y2):
    ...
    iMy = np.vstack(
        [
            t5 * t10 * y1 * (-8.023278807758917e-1)
            - t5 * t14 * y1 * 6.760740228704583e1
            + t8 * t13 * y1 * 8.023278807758917e-1
            + t8 * t15 * y1 * 6.760740228704583e1
            - t5 * t10 * t12 * y1 * 9.501254908070717e-1
            + t5 * t10 * t12 * y2 * 9.501254908070717e-1
            + t5 * t12 * t14 * y1 * 3.134662503279774e-1
            - t5 * t12 * t14 * y2 * 3.134662503279774e-1
            + t8 * t12 * t13 * y1 * 9.501254908070717e-1
            - t8 * t12 * t13 * y2 * 9.501254908070717e-1
            - t8 * t12 * t15 * y1 * 3.134662503279774e-1
            + t8 * t12 * t15 * y2 * 3.134662503279774e-1
            - t1 * t8 * t12 * t13 * y1 * 8.023278807758917e-1
            + t1 * t8 * t12 * t13 * y2 * 8.023278807758917e-1
            + t2 * t8 * t12 * t13 * y1 * 8.023278807758917e-1
            - t1 * t8 * t12 * t15 * y1 * 6.760740228704583e1
            - t2 * t8 * t12 * t13 * y2 * 8.023278807758917e-1
            + t1 * t8 * t12 * t15 * y2 * 6.760740228704583e1
            + t2 * t8 * t12 * t15 * y1 * 6.760740228704583e1
            - t2 * t8 * t12 * t15 * y2 * 6.760740228704583e1,
            t5 * t10 * y1 * 6.760740228704583e1
            - t5 * t14 * y1 * 8.023278807758917e-1
            - t8 * t13 * y1 * 6.760740228704583e1
            + t8 * t15 * y1 * 8.023278807758917e-1
            - t5 * t10 * t12 * y1 * 3.134662503279774e-1
            + t5 * t10 * t12 * y2 * 3.134662503279774e-1
            - t5 * t12 * t14 * y1 * 9.501254908070717e-1
            + t5 * t12 * t14 * y2 * 9.501254908070717e-1
            + t8 * t12 * t13 * y1 * 3.134662503279774e-1
            - t8 * t12 * t13 * y2 * 3.134662503279774e-1
            + t8 * t12 * t15 * y1 * 9.501254908070717e-1
            - t8 * t12 * t15 * y2 * 9.501254908070717e-1
            + t1 * t8 * t12 * t13 * y1 * 6.760740228704583e1
            - t1 * t8 * t12 * t13 * y2 * 6.760740228704583e1
            - t2 * t8 * t12 * t13 * y1 * 6.760740228704583e1
            - t1 * t8 * t12 * t15 * y1 * 8.023278807758917e-1
            + t2 * t8 * t12 * t13 * y2 * 6.760740228704583e1
            + t1 * t8 * t12 * t15 * y2 * 8.023278807758917e-1
            + t2 * t8 * t12 * t15 * y1 * 8.023278807758917e-1
            - t2 * t8 * t12 * t15 * y2 * 8.023278807758917e-1,
            t17 * t22 * y1 * (-6.843274120037415)
            + t17 * t24 * y1 * 5.58745119585928
            + t20 * t23 * y1 * 6.843274120037415
            - t20 * t25 * y1 * 5.58745119585928
            - t12 * t17 * t22 * y1 * 3.843934011732957e-1
            + t12 * t17 * t22 * y2 * 3.843934011732957e-1
            - t12 * t17 * t24 * y1 * 1.070388643317791
            + t12 * t17 * t24 * y2 * 1.070388643317791
            + t12 * t20 * t23 * y1 * 3.843934011732957e-1
            - t12 * t20 * t23 * y2 * 3.843934011732957e-1
            + t12 * t20 * t25 * y1 * 1.070388643317791
            - t12 * t20 * t25 * y2 * 1.070388643317791
            - t1 * t12 * t20 * t23 * y1 * 6.843274120037415
            + t1 * t12 * t20 * t23 * y2 * 6.843274120037415
            + t2 * t12 * t20 * t23 * y1 * 6.843274120037415
            + t1 * t12 * t20 * t25 * y1 * 5.58745119585928
            - t2 * t12 * t20 * t23 * y2 * 6.843274120037415
            - t1 * t12 * t20 * t25 * y2 * 5.58745119585928
            - t2 * t12 * t20 * t25 * y1 * 5.58745119585928
            + t2 * t12 * t20 * t25 * y2 * 5.58745119585928,
            t17 * t22 * y1 * 5.58745119585928
            + t17 * t24 * y1 * 6.843274120037415
            - t20 * t23 * y1 * 5.58745119585928
            - t20 * t25 * y1 * 6.843274120037415
            - t12 * t17 * t22 * y1 * 1.070388643317791
            + t12 * t17 * t22 * y2 * 1.070388643317791
            + t12 * t17 * t24 * y1 * 3.843934011732957e-1
            - t12 * t17 * t24 * y2 * 3.843934011732957e-1
            + t12 * t20 * t23 * y1 * 1.070388643317791
            - t12 * t20 * t23 * y2 * 1.070388643317791
            - t12 * t20 * t25 * y1 * 3.843934011732957e-1
            + t12 * t20 * t25 * y2 * 3.843934011732957e-1
            + t1 * t12 * t20 * t23 * y1 * 5.58745119585928
            - t1 * t12 * t20 * t23 * y2 * 5.58745119585928
            - t2 * t12 * t20 * t23 * y1 * 5.58745119585928
            + t1 * t12 * t20 * t25 * y1 * 6.843274120037415
            + t2 * t12 * t20 * t23 * y2 * 5.58745119585928
            - t1 * t12 * t20 * t25 * y2 * 6.843274120037415
            - t2 * t12 * t20 * t25 * y1 * 6.843274120037415
            + t2 * t12 * t20 * t25 * y2 * 6.843274120037415,
        ]
    )
    return iMy
...
def fM(t):
    ...
    M = np.vstack(
        [
            -t3 * (t4 * 1.009488570317789e-3 + t5 * 8.315147588488827e-4),
            -t3 * (t4 * 3.296477717707572e-2 - t5 * 8.200505959666402e-2),
            -t3 * (t4 * 4.45117663500498e-3 - t5 * 1.404985422724839e-2),
            t3 * t4 * 9.959766924004811e-1,
            t3 * (t4 * 8.315147588488827e-4 - t5 * 1.009488570317789e-3),
            -t3 * (t4 * 8.200505959666402e-2 + t5 * 3.296477717707572e-2),
            -t3 * (t4 * 1.404985422724839e-2 + t5 * 4.45117663500498e-3),
            t3 * t5 * 9.959766924004811e-1,
            -t7 * (t8 * 4.238836503712554e-2 - t9 * 1.19852508949723e-1),
            t7 * t8 * 9.875165438583369e-1,
            t7 * (t8 * 4.057897959535129e-3 + t9 * 1.115993043207963e-2),
            t7 * (t8 * 7.121835021721261e-2 - t9 * 5.862264258169474e-2),
            -t7 * (t8 * 1.19852508949723e-1 + t9 * 4.238836503712554e-2),
            t7 * t9 * 9.875165438583369e-1,
            -t7 * (t8 * 1.115993043207963e-2 - t9 * 4.057897959535129e-3),
            t7 * (t8 * 5.862264258169474e-2 + t9 * 7.121835021721261e-2),
        ]
    ).reshape((4, 4))
    return M.transpose()
...
def iri(Y, segment_length, start_pos, step, box_filter=True, method=2):
    ...
    if type(overlap) == bool and overlap == True:
        print(
            "overlap parametr cannot be logical true, must be either false or a number containing overlap size."
        )
        return
    ...
    if any(np.diff(Y[:, 0]) <= 0):
        print(
            "First column of the first parameter (stationing) should be sorted and non-duplicated."
        )
        return
    if start_pos < Y[0, 0]:
    ...
    if method == 0:
        ...
        if equidistant == False:
            print(
                "Sayers method for irregular sampling does not work, first resample to equidistant samples."
            )
            return
        if np.count_nonzero(YC[:, 0] == start_pos) == 0:
            print(
                "Starting positions in Sayers method must coincide with input sampling."
            )
            return
    ...
    mask = np.hstack((True, mask))
    YC = YC[mask, :]
    si = np.where(YC[:, 0] == start_pos)[
        0
    ]  # si = index of the beginning of the first segment
    if len(si) == 0:
    ...
    if overlap == False:
        ...
        if method == 0 and (overlap % dx) > 0:  # overlap must be a multiple of dx
            print(
                "Sayers method with overlapped segments requires the overlap to be a multiple of the sampling step."
            )
            return
        start_X_o = np.arange(
            start_pos, YC[-1, 0] - segment_length + 0.001, overlap
        )  # lower ends of the segments
        end_X_o = np.arange(
            start_pos + segment_length, YC[-1, 0] + 0.001, overlap
        )  # upper ends
        ...
        if ((YC[-1, 0] - start_pos) % segment_length) > 0:
            YC = np.vstack(
                (YC, np.hstack((start_pos + nsegments_aux * segment_length, YC[-1, 1])))
            )  # add one dummy sample point
            # dummy = true;
            nsegments = int(nsegments_aux)  # increase the number of segments by one
            start_si = np.hstack(
                (start_si, end_si[-1])
            )  # from the end to the dummy point
    ...
    Y = np.unique(
        Y, axis=0
    )  # just in case /v create duplicates (not solved in YC for now)
    ...
    for s in range(nsegments):
        ...
        ei = end_si[s]
        Y = np.hstack(
            (YC[si : ei + 1, 0:1] - YC[si, 0:1], YC[si : ei + 1, 1:])
        )  # set the first point to start at distance 0
        ft = (
            Y[:, 0] / v
        )  # convert top view distance along the profile to time for car speed 80km/h
        ...
        if method == 0:  # M.Sayers
            ...
            for i in range(Y.shape[0] - 1):
                Z[i + 1, :] = np.transpose(np.matmul(S, Z[i, :])) + (p * DY[i]).reshape(
                    4,
                )
    ...
    for s in range(nsegments_o):
        ...
        IRI[s, 2] = np.sum(
            DD[start_si_o[s] - start_si_o[0] + 1 : end_si_o[s] - start_si_o[0] + 1]
        )
        IRI[s, 3] = np.std(
            DD[start_si_o[s] - start_si_o[0] + 1 : end_si_o[s] - start_si_o[0] + 1]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default=" ",
        help="Delimiter used in the input file. If missing, set to the space character.",
    )
    parser.add_argument(
        "-skip_header",
        type=int,
        default=0,
        help="Number of header lines to skip in the input file. If missing, set to zero.",
    )
    parser.add_argument(
        "-plot_file",
        type=str,
        help="Name of the output IRI plot file. If missing, the file is not created. The file format is inferred from its extension, typically pdf, svg or png. For available formats, see the matplotlib savefig function.",
    )
    parser.add_argument(
        "iri_file",
        type=str,
    ...
    parser.add_argument(
        ...
        type=float,
        default=20,
        help="Length of the IRI segment (typically 20 or 100 meters). If missing, set to 20m.",
    )
    parser.add_argument(
        "-start_pos",
        type=float,
        default=-1,
        help="Starting position of IRI segments. If empty, set to the first sample.",
    )
    parser.add_argument(
        "-step",
        type=float,
        default=0,
        help="If missing or 0, IRI is computed in non-overlapping segments. Otherwise, this is the shift of consecutive IRI segments in meters, often set to sampling step for regular sampling.",
    )
    parser.add_argument(
        "-filter_off",
        action="store_true",
        help="If missing, for sampling intervals shorter than 0.25m, profile is first averaged with a box filter of length 0.25m as recommended in Sayers' paper to better represent the way in which the tire of a vehicle envelops the ground. If present, the filtering is turned off completely.",
    )
    parser.add_argument(
        "-method",
        type=int,
        default=2,
        choices=[0, 2],
        help="0 - Sayers' implementation, for irregular sampling first resampled; 2(default) - our semi-analytical solution (Sroubek & Sorel).",
    )

    args = parser.parse_args()
    road_profile = np.genfromtxt(
        args.input_file, delimiter=args.delimiter, skip_header=args.skip_header
    )
    if args.filter_off:
        box_filter = False
    else:
    ...
    np.savetxt(
        ...
        Solution,
        fmt="%s",
        header="Start, End, IRI value, IRI std. deviation",
